...
import { Person, Biography, SanityPerson, SanityBiography } from '@/types'
 ...
 */
export function adaptSanityPerson(sanityPerson: SanityPerson, children?: SanityPerson[]): Person {
  return {
    id: sanityPerson._id,
    ...
    photo: sanityPerson.photo ? urlForImage(sanityPerson.photo).url() : undefined,
 ...
 */
export function getImageUrl(source: SanityImageSource | undefined, width?: number): string | undefined {
