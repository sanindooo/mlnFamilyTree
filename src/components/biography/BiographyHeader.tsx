...
export function BiographyHeader({ 
  ...
  return (
    <section id="bio-header" className="py-12 md:py-16 lg:py-20">
              ...
              <div className="rb-4 mb-6 flex items-center md:mb-8">
                <div>
                  <h6 className="font-semibold text-deep-umber">
                    <span className="font-normal text-muted">Category</span> {category}
                  </h6>
                </div>
              </div>
              <div>
                <p className="text-base font-semibold text-deep-umber">Share this biography</p>
