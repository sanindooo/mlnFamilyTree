...
export function AncestorHero() {
  return (
    <section id="ancestor-hero" className="relative py-12 md:py-16 lg:py-20 bg-deep-umber">
      <div className="container relative z-10 max-w-lg text-center">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-4 md:mt-8">
          <Button className="bg-cream text-deep-umber border-cream hover:bg-cream/90">Explore</Button>
          <Button variant="secondary" className="text-cream border-cream hover:bg-cream/10 hover:text-cream">
            Share
          </Button>
        </div>
      </div>
